<?php 
  ...
  if(isset($_POST['btnSave'])!=""){
    ...
    $InsertSQL = "INSERT INTO suburbs (SuburbName) VALUES ('$SuburbName')";
  ...
  $SelectSql = "SELECT * FROM suburbs LIMIT $offset, $no_of_records_per_page";
  $query = mysqli_query($connection,$SelectSql);
?>
...
<head>
  ...
  <title>Cities/Suburbs Table Administration</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      <br>
      <h1 id="IdUserAdminHdr" align="center" style="color:#FFF"><strong>Cities/Suburbs Administration</strong></h1>
      <div class="col-sm-2"></div>
      <div class="panel panel-primary col-sm-8">
        <div class="panel-heading">List of Cities/Suburbs</div>
        <div class="panel-body" style="color:black">
          <table class="table" style="color:black"> 
            ...
            <tbody> 
              ...
              ?>
              <tr> 
                <td><?php echo $row['SuburbName']; ?></td>
                <td>
                  <a href="EditSuburb.php?cid='<?php echo $row['SuburbName']; ?>'"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                   <a href="delete.php?cid=<?php echo $row['SuburbName']; ?>" onclick="return ConfirmDelete('<?php echo $row['SuburbName']; ?>');"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
          ...
          <form id="Form" action="" method="post" enctype="multipart/form-data" data-toggle="validator" autocomplete="off" >
            <div class="col-sm-6">
              <br>
              <input type="text" class="form-control" id="IdFName" name="SuburbName" maxlength="35" value="" autofocus>
            </div> 
            <div class="col-sm-1">
              <br>
